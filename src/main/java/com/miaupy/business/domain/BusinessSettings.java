...
public record BusinessSettings(
  ...
  public static BusinessSettings create(
    ...
    return new BusinessSettings(tenant, mode, timezone, currency, booking, sales, now, now);
  }

  public BusinessSettings update(
      AppointmentApprovalMode mode,
      String timezone,
      String currency,
      boolean booking,
    ...
    return new BusinessSettings(
        tenantId, mode, timezone, currency, booking, sales, createdAt, Instant.now());
  }
}
