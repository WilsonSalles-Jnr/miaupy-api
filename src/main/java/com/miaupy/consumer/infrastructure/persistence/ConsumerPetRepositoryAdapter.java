...
class ConsumerPetRepositoryAdapter implements ConsumerPetRepository {
  ...
  ConsumerPetRepositoryAdapter(SpringDataConsumerPetRepository repository) {
    this.repository = repository;
  }

  public ConsumerPet save(ConsumerPet pet) {
    return map(repository.save(new ConsumerPetJpaEntity(pet)));
  }
